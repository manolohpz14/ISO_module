...
#### 7.2 Uso en Discos físicos (ejemplo: un pendrive)
...
sudo mount /dev/sdb1 /mnt
  ```
Ahora en /mnt ves los archivos del pendrive. Si creas algo dentro de /mnt, se escribe en el pendrive. Cuando desmontas (sudo umount /mnt), el contenido del host en /mnt reaparece (si había algo).

----

#### 7.3 Ahora bien, aunque similar, para montar discos virtual es un poco distinto. Lo primero es instalar mediante apt una libreria:
...
#### 7.3 Por ultimo vemos como pasar la informacion de la VM al host
