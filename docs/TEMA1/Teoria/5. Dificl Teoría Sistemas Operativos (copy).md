...
![](file:///home/manolo/Im%C3%A1genes/Capturas%20de%20pantalla/Captura%20desde%202025-09-26%2011-00-45.png)
...
Esta forma de computación se conoce como **grid**. Los grandes retos de cálculo de hoy en día, como el descubrimiento de  medicamentos, simulación de terremotos, inundaciones y otras catástrofes naturales,  modelización del clima/tiempo, grandes buscadores de internet, el  programa [Seti@Home](http://setiweb.ssl.berkeley.edu/), etc. Son posibles gracias a estos sistemas operativos distribuidos que permiten utilizar la computación distribuida.
...
Aunque ojo, la mayoría de estos ya están en desuso...
...
A día de hoy, ¿cuál es la tendencia?
...
Puedes instalarlo con interfaz gráfica o en Server Core (modo sin GUI).
...
Los sistemas Windows de escritorio tienen una historia larga que arranca en los años 80 y que ha pasado por varias generaciones, cada una con sus propios avances y limitaciones. **Windows 3.11** (1993) fue el último de la línea “clásica” que funcionaba como una interfaz gráfica encima de MS-DOS. No era un sistema operativo moderno en sí mismo, ya que dependía de DOS para arrancar y para muchas operaciones básicas.
...
A partir de ahí, todas las versiones de escritorio —Vista, 7, 8, 8.1 y finalmente 10— se construyeron sobre NT. Algunas fueron más exitosas que otras: Vista fue criticado por su consumo de recursos, mientras que Windows 7 se consolidó como un sistema estable y ampliamente adoptado. Windows 8 introdujo la interfaz Metro, pensada para tablets, que no convenció a muchos usuarios, y por eso Windows 8.1 y Windows 10 recuperaron un enfoque más tradicional de escritorio.

Ahora bien, cada una de estas versiones tiene un ciclo de vida definido por Microsoft:

- Durante el soporte principal, el sistema recibe nuevas funciones, mejoras y actualizaciones de seguridad.
- Cuando entra en soporte extendido, ya no recibe novedades, pero sí parches de seguridad críticos.
- Una vez expira ese ciclo (normalmente 10 años desde el lanzamiento), el sistema queda sin soporte, lo que significa que sigue funcionando, pero se vuelve un riesgo de seguridad porque no recibe más actualizaciones.

Por ejemplo:

- Windows XP salió en 2001 y estuvo soportado hasta 2014 (13 años en total, con varias prórrogas).
- Windows 7 salió en 2009 y su soporte finalizó en 2020.
- Windows 8.1 salió en 2013 y caducó en 2023.

Esto significa que, a día de hoy, Microsoft empuja a todos los usuarios hacia Windows 11, que es la versión en activo con soporte completo.

[![Fin del Soporte](https://github.com/aberlanas/ASIR-ISO/raw/master/UD01_IntroduccionSistemasOperativos/Versiones/fin-soporte-windows.png)](https://github.com/aberlanas/ASIR-ISO/blob/master/UD01_IntroduccionSistemasOperativos/Versiones/fin-soporte-windows.png)

### 4.3 Actualizaciones de Windows 10
...
[<img src="https://github.com/aberlanas/ASIR-ISO/raw/master/UD01_IntroduccionSistemasOperativos/Versiones/Gnu-and-penguin-color.png" alt="GNU/LinuX" style="zoom:50%;" />](https://github.com/aberlanas/ASIR-ISO/blob/master/UD01_IntroduccionSistemasOperativos/Versiones/Gnu-and-penguin-color.png)
